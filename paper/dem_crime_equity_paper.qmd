...
abstract: |
  ...
  moves with its denominator for reasons that have nothing to do with Black residents. The choice
  ...
  the answer. The substantive findings are secondary to that methodological point. Methods include
  multilevel models, group-based trajectory modeling, and synthetic control.
format:
  pdf:
    pdf-engine: xelatex
...
decide what we are able to conclude, and careful choices keep overturning the convenient answer. The
...
heavily too, and the large white denominator pulls the ratio down. The measure reported most often,
